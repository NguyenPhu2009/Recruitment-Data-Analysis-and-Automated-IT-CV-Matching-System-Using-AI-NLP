...
class Config:
    # Lấy SECRET_KEY từ .env, fallback dùng key tạm cho local
    SECRET_KEY = os.environ.get('SECRET_KEY') or 'ats_super_secret_key_2026'

    MAX_CONTENT_LENGTH = 5 * 1024 * 1024

    # Lấy thông tin kết nối DB từ .env
    ...
    # BỔ SUNG QUAN TRỌNG: Tự động kiểm tra và làm mới kết nối MySQL trước mỗi query
